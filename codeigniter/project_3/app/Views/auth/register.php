...
<head>
    ...
    <title>Daftar - Kampus Portal</title>
    ...
    <style>
        ...
        body { background-color: var(--bg-color); color: var(--text-main); font-size: 14px; font-family: system-ui, -apple-system, sans-serif; display: flex; align-items: center; justify-content: center; min-height: 100vh; padding: 40px 0; position: relative; }
...
<div class="card">
    <h3 class="text-center fw-bold text-accent mb-4">Daftar Akun</h3>
    ...
    <form action="<?= base_url('auth/register') ?>" method="post">
        ...
        <div class="mb-3">
            <label class="form-label text-muted">NIM (Opsional)</label>
            <input type="text" name="nim" class="form-control" placeholder="NIM (khusus mahasiswa)" value="<?= old('nim') ?>">
        </div>
        <div class="mb-3">
    ...
    <div class="text-center">
        <span class="text-muted">Sudah punya akun?</span> <a href="<?= base_url('auth/login') ?>" class="text-accent text-decoration-none fw-bold">Login di sini</a>
    </div>
</div>
</body>
</html>
